window.onload = function init() {
    ...
    const groundY = -1;
    const epsilon = -1e-2;
    const shadowMatrixParallel = computeShadowMatrix(lightPosition, groundY + epsilon, mat4());
    const shadowMatrixPerpendicular = computeShadowMatrix(lightPosition, groundY + epsilon, mat4());
    ...
    function render() {
        ...
        gl.uniform1f(u_Visibility, 0.5); // Semi-transparent shadows
