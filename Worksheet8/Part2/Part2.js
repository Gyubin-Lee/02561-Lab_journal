window.onload = function init() {
    ...
    const shadowMatrixParallel = computeShadowMatrix(lightPosition, groundY, mat4());
    const shadowMatrixPerpendicular = computeShadowMatrix(lightPosition, groundY, mat4());
