window.onload = function init() {
    ...
    const sphereProgram = initShaders(gl, "vertex-shader-sphere", "fragment-shader-sphere");
    ...
    normalImage.src = "../textures/normalmap.png";
    ...
    function render() {
        ...
        const rotationalInverse = inverse(extractRotationMatrix(viewMatrix));
        ...
        const a_TexCoord = gl.getAttribLocation(sphereProgram, "a_TexCoord");
        ...
        const u_EyePosition = gl.getUniformLocation(sphereProgram, "u_EyePosition");
        const u_CubeMap = gl.getUniformLocation(sphereProgram, "u_CubeMap");
        const u_NormalMap = gl.getUniformLocation(sphereProgram, "u_NormalMap");
